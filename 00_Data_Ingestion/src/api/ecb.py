...
if __name__ == "__main__":
    series_map = {
        ...
        (
            "MIR",
            "M.U2.B.A2C.A.R.A.2250.EUR.N",
        ): "bank_interest_rates_house_purchase.csv",
        ...
        (
            "MIR",
            "M.U2.B.A2Z.A.B.A.2250.EUR.N",
        ): "bank_business_volumes_credit_cards.csv",
    }
    ...
    for (dataset, series_key), filename in series_map.items():
        try:
            ...
            upload_to_s3(s3, filename, s3_path, bucket_name="01-structured-data")
