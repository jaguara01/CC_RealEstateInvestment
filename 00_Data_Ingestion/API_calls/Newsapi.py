...
def export_to_csv(local_filename):
    try:
        ...
        with open(local_filename, 'w', newline='', encoding='utf-8') as csvfile:
            fieldnames = ['Title', 'Description', 'URL', 'Published_At', 'Source', 'Content', 'Language']
            ...
            print(f"Successfully saved {len(data['articles'])} articles to {local_filename}")
...
if __name__ == "__main__":
    try:
        ...
        utils.upload_to_s3(s3, local_filename, f"news/newsapi/{local_filename}", "02-semistructured-data")
    except Exception as e:
